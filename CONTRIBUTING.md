# Contributing to ANM-butterfly-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
ANM-butterfly-schema. These guidelines are not strict rules.
...
The ANM-butterfly-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the ANM-butterfly-schema technical leads
...
[issues]: https://github.com/ANM-Butterfly-Network/ANM-butterfly-schema/issues/
[pulls]: https://github.com/ANM-Butterfly-Network/ANM-butterfly-schema/pulls/
